...
/*	driver->draw2DRectangle(SColor(100, 0, 0, 0),
								rect<s32>(w / 2 - 209, h - 140, w / 2 + 209, h - 100));
	driver->draw2DRectangle(SColor(255, 200, 200, 200), 
...
/*	s32 ltx = w / 2 - 207 + handItemId * 42 - 42;
	s32 lth = h - 138;
	driver->draw2DRectangleOutline(recti(ltx, lth, ltx + 35, lth + 35), SColor(255, 255, 255, 255));*/
}
